...
import com.zhangchao.service.EmployeeService;
...
public class EmployeeController {
    ...
    public String list(Model model){
        Collection<Emp> employees = employeeDao.getAll();
        //放在请求域中
    ...
    public String toAddPage(Model model){
        ...
        Collection<Dept> departments = departmentDao.getDepartments();
    ...
    public String toEditPage(@PathVariable("id") Integer id,Model model){
        Emp employee = employeeDao.get(id);
     ...
     */
    @PutMapping("/emp")
    public String updateEmployee(Emp employee){
